...
function NotificationSettingsPage() {
  ...
  const updateNotifications = useMutation(
    ...
    if (existingPrefs !== undefined && existingPrefs !== null) {
      localStore.setQuery(api.preferences.getMine, {}, {
        ...existingPrefs,
        ...
        ...(args.todoReminders !== undefined && { todoReminders: args.todoReminders }),
  ...
  const emailNotifications = preferences?.emailNotifications ?? DEFAULT_PREFERENCES.emailNotifications;
  const pushNotifications = preferences?.pushNotifications ?? DEFAULT_PREFERENCES.pushNotifications;
  const todoReminders = preferences?.todoReminders ?? DEFAULT_PREFERENCES.todoReminders;
  const weeklyDigest = preferences?.weeklyDigest ?? DEFAULT_PREFERENCES.weeklyDigest;
  const mentions = preferences?.mentions ?? DEFAULT_PREFERENCES.mentions;
  const marketingEmails = preferences?.marketingEmails ?? DEFAULT_PREFERENCES.marketingEmails;
