...
const features = [
  {
    ...
    description: "Changes sync instantly across all clients without polling or manual refresh. Build collaborative features effortlessly.",
    icon: RefreshCw,
  ...
  {
    title: "Type-Safe",
    description: "End-to-end TypeScript from database to UI. Catch errors at compile time.",
    icon: Shield,
  },
  {
    title: "2X Faster",
    description: "Skip the boilerplate. No REST APIs, no state management headaches.",
    icon: Rocket,
    stat: "2X",
  },
  {
    title: "Modern Stack",
    description: "TanStack Start with SSR, file-based routing, and server functions.",
    icon: Database,
  },
  {
    title: "Developer Experience",
    description: "Hot reload, TypeScript, ESLint, and Prettier configured out of the box.",
    icon: Code2,
  },
];
